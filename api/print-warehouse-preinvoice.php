...
$documentNo = 'PRE-' . date('YmdHis') . '-' . $warehouseId;
...
<head>
    ...
    <title>فاتورة مبدئية <?= e($warehouse['name'] ?? ''); ?></title>
    <style>
        * { box-sizing: border-box; }
        ...
        .print-btn { border: 0; background: #0f766e; color: #fff; padding: 10px 18px; border-radius: 8px; cursor: pointer; font-weight: 700; }
        .sheet { width: 210mm; min-height: 297mm; margin: 0 auto; background: #fff; padding: 10mm; box-shadow: 0 8px 24px rgba(0,0,0,.08); }
        .header { display: flex; justify-content: space-between; align-items: center; gap: 16px; border-bottom: 2px solid #ccfbf1; padding-bottom: 10px; margin-bottom: 12px; }
        ...
        .badge { display: inline-block; background: #ecfeff; color: #115e59; border: 1px solid #99f6e4; border-radius: 999px; padding: 5px 10px; font-size: 12px; font-weight: 700; }
        ...
        td.blank { height: 34px; }
        .notes { margin-top: 14px; display: grid; gap: 8px; }
        .note-box { border: 1px dashed #cbd5e1; min-height: 48px; border-radius: 10px; padding: 10px; font-size: 13px; }
        @media print {
...
<body>
    ...
    <div class="sheet">
        <div class="header">
            <div class="brand">
                ...
                <div>
                    ...
                    <div class="muted">فاتورة مبدئية للمسوق</div>
                    <div class="badge">فقط الأصناف المتوفرة داخل المخزن</div>
                </div>
            </div>

            <div class="muted">
                <div>رقم المستند: <?= e($documentNo); ?></div>
                <div>تاريخ الطباعة: <?= e($printDate); ?></div>
            </div>
        </div>
        ...
        <div class="meta">
            ...
            <div class="meta-card">
                <strong>الفرع</strong>
                <?= e($warehouse['branch_name'] ?? '-'); ?>
            </div>

            <div class="meta-card">
                <strong>المسوق</strong>
                <?= e($warehouse['marketer_name'] ?? '-'); ?>
            </div>

            <div class="meta-card">
                <strong>نوع المستند</strong>
                فاتورة مبدئية عرض أصناف
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6">لا توجد أصناف متوفرة داخل هذا المخزن.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
        ...
        <div class="notes">
            <div class="note-box"><strong>ملاحظات:</strong></div>
            <div class="note-box"><strong>اعتماد المسوق:</strong></div>
        </div>
    </div>
</body>
</html>